import {gameMain, addPearl, getToken} from '../services/gameService';
...
export const gameController = async (req: Request, res: Response): Promise<any> => {
    try {
        ...
        const result = await gameMain(parseBody.data.initData);
...
export const getTokenController = async (req: Request, res: Response): Promise<any> => {
    try {
